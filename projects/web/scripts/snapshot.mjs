...
import { filesIn, generateVersion, webRoot } from "./generate.mjs"
import { validateSnapshot } from "./versions.mjs"

const args = process.argv.slice(2)
if (args.length !== 2 || args[0] !== "--out") throw new Error("Use snapshot.mjs --out NEW_FILE")
