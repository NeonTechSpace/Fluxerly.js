...
export const registryScope = {
    ...
    established: [
        ...
        "source-derived supported request, response, direct-parameter and EventMap field inventories with explicit rules or local exclusions",
        "reviewed default/native semantic field baseline including union variants, types, optionality and nullability",
        "authored field defaults, length units and normalization tied to pinned provider owners and SDK behavior tests",
        ...
        "client construction and PKCE factory inventory",
        "shared source and packed OAuth, webhook and local shutdown reference cases",
        "exact runtime value-export inventories and intentional differences for both public entrypoints",
        "shared source and packed gateway identify, event delivery, resume, invalid-session reset, terminal close and cancellation reference",
    ],
    remaining: [
        "universal provider-schema equivalence outside the explicitly indexed public SDK surface",
