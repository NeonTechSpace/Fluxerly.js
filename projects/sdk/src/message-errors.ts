...
/**
 * Expected fetch, history, edit or delete failure with safe metadata, never a response body, credential or message content.
...
export class MessageOperationError extends Error {
    ...
    constructor(
        ...
        readonly operation: "fetch" | "fetchHistory" | "edit" | "delete",
...
/** Fetch, history, edit and delete failures shared by both entry points. Native interruption remains outside this union */
