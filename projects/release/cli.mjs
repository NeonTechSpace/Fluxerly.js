...
import { withReleaseAuthentication } from "./authentication.mjs"
import { prepareCandidate, readCandidate } from "./candidate.mjs"
import { npmChannelTag, selectBaseline } from "./planning.mjs"
import { createRegistries } from "./registries.mjs"
import { inspectPublished, publishCandidate } from "./recovery.mjs"
import { readSourcePlan, versionSource } from "./source.mjs"
import { assertReleaseSupport } from "./support.mjs"
...
async function stage(options) {
    const { stageRelease } = await import("../sdk/scripts/packages.mjs")
